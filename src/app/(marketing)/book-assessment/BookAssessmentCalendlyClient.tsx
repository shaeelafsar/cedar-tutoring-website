    ...
    <>
      ...
      <section className="bg-muted/30 px-4 py-16 md:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-5xl space-y-12">
          ...
          {/* Primary: heading + Calendly inline embed */}
          <motion.div
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {testimonials.map((testimonial) => (
                <article
                  key={testimonial.id}
                  className="border-border bg-muted/35 flex flex-col rounded-2xl border p-5"
                >
                  ...
                  <div className="text-muted-foreground mt-auto pt-4 text-sm leading-6">
