...
export const freeTrialPageFrontmatterSchema = z.object({
  ...
  introHeading: nonEmptyString,
  introParagraphs: z.array(nonEmptyString),
  bookingEyebrow: nonEmptyString,
  bookingHeading: nonEmptyString,
  bookingSubtitle: nonEmptyString,
  bookingCalendlyUrl: nonEmptyString.url(),
  bookingFallbackPhone: nonEmptyString,
...
export const freeTrialPageContentSchema = z.object({
  ...
  booking: z.object({
    ...
    heading: nonEmptyString,
    subtitle: nonEmptyString,
    calendlyUrl: nonEmptyString.url(),
    fallbackPhone: nonEmptyString,
  }),
